...
def main():
    ...
    metrics = {
        ...
        "Reads per cell (mean)": raw_fastq_reads / estimated_cells if estimated_cells > 0 else 0,
        "Mean reads per cell": raw_fastq_reads / estimated_cells if estimated_cells > 0 else 0,
